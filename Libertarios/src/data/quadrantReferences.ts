...
export interface ReferencePoint {
  ...
  role?: string;
  /**
   * Medidas concretas, aplicadas o propuestas.
   *
   * Es lo que sostiene la coordenada: sin ellas la posición es una opinión
   * nuestra, y con ellas el lector puede comprobar por qué está donde está.
   * Solo hechos documentados, nunca intenciones atribuidas.
   */
  policies?: string[];
...
const thinkers: ReferencePoint[] = [
  ...
  { id: "rallo", kind: "thinker", role: "Economista, España", initials: "JR", label: "Juan Ramón Rallo", short: "Rallo", economic: 88, social: 75, note: "El economista liberal más leído en España. Anarcocapitalista en la teoría y muy crítico con el proteccionismo, también cuando viene de su propio bando.", policies: ["Sustituir el sistema público de pensiones por capitalización", "Eliminar el impuesto de sociedades y gravar solo el consumo y la renta", "Liberalizar el suelo para aumentar la oferta de vivienda", "Crítica frontal al proteccionismo, también cuando lo propone la derecha"] },
...
const leaders: ReferencePoint[] = [
  { id: "milei", kind: "leader", role: "Presidente de Argentina", initials: "JM", color: "#7B3FA0", label: "Javier Milei 🇦🇷", short: "Milei", economic: 86, social: 28, note: "Recorte del gasto y desregulación a gran escala. Anarcocapitalista en la teoría, minarquista en la práctica; conservador en varias cuestiones sociales.", contested: true, policies: ["Reducción del número de ministerios de 18 a 9 en 2023", "Decreto 70/2023: derogación o reforma de cientos de normas económicas", "Superávit fiscal primario como objetivo central del mandato", "Levantamiento progresivo del control de cambios"] },
  ...
  { id: "abascal", kind: "leader", role: "Líder de Vox, España", initials: "SA", color: "#63BE21", label: "Santiago Abascal 🇪🇸", short: "Abascal", economic: 0, social: -62, note: "Proteccionismo agrario e industrial junto a gasto social propio; conservadurismo social marcado.", policies: ["Bajada de impuestos junto a aumento del gasto en defensa y agro", "Proteccionismo agrario y cláusulas de preferencia nacional", "Derogación de las leyes de memoria histórica", "Endurecimiento penal y de la política migratoria"] },
  { id: "orban", kind: "leader", role: "Primer ministro de Hungría", initials: "VO", color: "#FF6A00", label: "Viktor Orbán 🇭🇺", short: "Orbán", economic: -15, social: -70, note: "Capitalismo de amiguetes, control de medios y reforma constitucional para consolidar el poder.", policies: ["Reforma constitucional de 2011 y control del Tribunal Constitucional", "Impuestos extraordinarios a banca, energía y multinacionales", "Concentración de la propiedad de medios en fundaciones afines", "Tipo único del IRPF del 15 % junto a fuertes ayudas natalistas"] },
  { id: "starmer", kind: "leader", role: "Primer ministro del Reino Unido", initials: "KS", color: "#E4003B", label: "Keir Starmer 🇬🇧", short: "Starmer", economic: -35, social: 45, note: "Laborismo fiscalmente contenido, con más gasto en servicios públicos.", policies: ["Subida de cotizaciones empresariales para financiar sanidad", "Fin de la exención fiscal a los colegios privados", "Creación de una empresa pública de energía", "Reforma de la planificación urbanística para construir más vivienda"] },
  { id: "lepen", kind: "leader", role: "Líder del RN, Francia", initials: "ML", color: "#0D378A", label: "Marine Le Pen 🇫🇷", short: "Le Pen", economic: -42, social: -62, note: "Proteccionismo, jubilación anticipada y preferencia nacional.", policies: ["Rebaja de la edad de jubilación a los 60 años en algunos casos", "Preferencia nacional en vivienda social y ayudas", "Proteccionismo industrial y renegociación de tratados", "Bajada del IVA a la energía"] },
  { id: "sanchez", kind: "leader", role: "Presidente del Gobierno, España", initials: "PS", color: "#E30613", label: "Pedro Sánchez 🇪🇸", short: "Sánchez", economic: -52, social: 55, note: "Ampliación del gasto público y del salario mínimo, junto a ampliación de derechos civiles.", policies: ["Subida del salario mínimo por encima del 50 % desde 2018", "Ley de eutanasia en 2021", "Reforma laboral que limita la contratación temporal", "Impuestos temporales a la banca y a las energéticas"] },
  { id: "lula", kind: "leader", role: "Presidente de Brasil", initials: "LL", color: "#C4122E", label: "Lula da Silva 🇧🇷", short: "Lula", economic: -62, social: 45, note: "Programas sociales amplios e intervención estatal en sectores estratégicos.", policies: ["Ampliación de los programas de transferencia de renta", "Subidas del salario mínimo por encima de la inflación", "Nueva regla fiscal que sustituye al techo de gasto", "Política industrial activa y refuerzo de las empresas públicas"] },
  { id: "xi", kind: "leader", role: "Secretario general del PCCh, China", initials: "XJ", color: "#DE2910", label: "Xi Jinping 🇨🇳", short: "Xi Jinping", economic: -58, social: -92, note: "Reafirmación del control del partido sobre la economía y vigilancia extensiva.", policies: ["Refuerzo del control del partido sobre las empresas privadas", "Sistema de crédito social y vigilancia digital extensiva", "Eliminación del límite de mandatos presidenciales en 2018", "Campaña regulatoria contra el sector tecnológico desde 2020"] },
];

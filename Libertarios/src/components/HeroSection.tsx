      ...
      <div className="container relative z-10 pt-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed opacity-0 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            Damos visibilidad a las personas con opiniones libertarias en España y 
            <span className="text-primary font-medium"> quitamos las etiquetas negativas</span> que a menudo se les atribuyen.
          </p>
